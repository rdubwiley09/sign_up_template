...
def signup():
    ...
    if signup.validate_on_submit():
        ...
        return redirect(url_for('signin'))
    return render_template('/index.jade', response=signup, event = event, title = "Sign-up for the Young Dems")
...
def signin():
    ...
    return render_template('/index.jade', response=signin, event = event, title = "Young Dems Sign-in")
